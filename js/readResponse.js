...
var url = "https://kn-bcb.herokuapp.com//api/cases/bcca/2013/173/citations";
var index = 0;
...
function dataSubmitted()
{
	...
	url = "https://kn-bcb.herokuapp.com//api/cases/bcca/" + caseYear + 
...
function referenceLoad(response)
{
	...
	url = "https://kn-bcb.herokuapp.com/api/cases/bcca/" + caseToQuery.year + "/" + caseToQuery.case_num + "/citations";
